...
#| tbl-cap: "Preview of the cleaned Anime Ranking dataset"
#| message: false
#| echo: false

colnames(anime_data) <- c("Score", "Popularity", "Number of users who have this work in list","Ranking")
