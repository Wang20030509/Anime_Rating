...
# License: MIT
# Pre-requisites: Create an account in MyAnimeList(MAL), then apply the client 
  #accessing the MAL API.
...
# API URL
url <- "https://api.myanimelist.net/v2/anime/ranking?ranking_type=favorite&limit=50&fields=mean,popularity,num_list_users,rank"
